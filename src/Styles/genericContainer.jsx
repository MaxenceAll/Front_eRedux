...
export const STYLEDContainerBox = styled.div`
  ...
  // inset -9.91px -9.91px 15px white;
  // box-shadow: 18px 18px 24px black,
  // -18px -18px 24px white;

  //3
  // box-shadow: inset 8.41px 8.41px 30px black, inset -8.41px -8.41px 30px white;
`;